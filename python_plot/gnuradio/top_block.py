...
class top_block(gr.top_block):
    ...
    def __init__(self):
        ...
        self.variable_qtgui_range_0_0_0 = analog.sig_source_c(samp_rate, analog.GR_SIN_WAVE, freq+300, 1, 0, 0)
        ...
        self.connect((self.variable_qtgui_range_0_0_0, 0), (self.blocks_add_xx_0, 2))
    ...
    def set_freq(self, freq):
        ...
        self.variable_qtgui_range_0_0_0.set_frequency(self.freq+300)
